...
namespace DotNetKoans.CSharp
{
	public class AboutDelegates : Koan
	{
		...
		public void RemovingMethods()
		{
            ...
            adding -= f.Add10;
			Assert.Equal(1, adding.GetInvocationList().Length);
			Assert.Equal("Add5", adding.Method.Name);
		}
		...
		{
			var countriesInSouthAmerica = new[] { "Argentina", "Bolivia", "Brazil", "Chile", "Colombia", "Ecuador", "French Guiana", "Guyana", "Paraguay", "Peru", "Suriname", "Uruguay", "Venezuela" };
			return countriesInSouthAmerica.Contains(country);
		}
		[Koan(19)]
